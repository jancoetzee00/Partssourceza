    ...
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/85 backdrop-blur-md flex items-center justify-center p-3 sm:p-6">
      <div className="relative w-full max-w-3xl bg-slate-900 border border-slate-700/80 rounded-3xl shadow-2xl overflow-hidden my-auto max-h-[92vh] flex flex-col">
        ...
        <form onSubmit={handleSubmit} className="overflow-y-auto p-6 space-y-5 flex-1 text-xs">
          ...
          {/* Submit Buttons */}
          <div className="pt-4 border-t border-slate-800 flex flex-col-reverse sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <div>
                  {!confirmDelete ? (
                    <button
                      ...
                      className="w-full sm:w-auto px-3.5 py-2 bg-red-950/40 hover:bg-red-900/60 text-red-400 border border-red-500/30 font-semibold rounded-xl text-xs transition-colors flex items-center justify-center gap-1.5 cursor-pointer whitespace-nowrap"
                    ...
                    <div className="flex flex-wrap items-center justify-between sm:justify-start gap-2 bg-red-950/60 border border-red-500/50 p-2 rounded-xl">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="px-2.5 py-1.5 bg-red-600 hover:bg-red-500 text-white font-bold rounded-lg text-xs transition-colors disabled:opacity-50 whitespace-nowrap cursor-pointer"
                        >
                        ...
                        <button
                          ...
                          className="px-2.5 py-1.5 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded-lg text-xs whitespace-nowrap cursor-pointer"
                        >
                          Cancel
                        </button>
                      </div>
            ...
            <div className="flex items-center justify-end gap-2.5 w-full sm:w-auto">
              <button
                ...
                className="flex-1 sm:flex-none px-4 py-2.5 bg-slate-800 hover:bg-slate-700 text-slate-300 font-semibold rounded-xl text-xs transition-colors text-center whitespace-nowrap cursor-pointer"
              >
                Cancel
              </button>
              ...
              <button
                type="submit"
                className="flex-1 sm:flex-none px-6 py-2.5 bg-amber-500 hover:bg-amber-400 text-slate-950 font-extrabold rounded-xl text-xs transition-all shadow-lg shadow-amber-500/20 text-center whitespace-nowrap cursor-pointer"
              >
